...
<div class="container-scroller">
    ...
    <ul class="navbar-nav navbar-nav-right">
      ...
      <li class="nav-item nav-profile dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
          <a href="ad_profile1.php" class="dropdown-item">
            <i class="ti-settings text-primary"></i> Settings </a>
          <a href="ad_code/logout.php" class="dropdown-item">
  ...
  <ul class="nav">
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="auth">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="ad_profile1.php"> Profile </a></li>
          <li class="nav-item"> <a class="nav-link" href="ad_register_other.php"> Register </a></li>
        </ul>
      </div>
    </li>
    ...
    <li class="nav-item">
      <a class="nav-link" href="ad_found.php">
        <i class="mdi mdi-account-convert menu-icon"></i>
        <span class="menu-title">FOUND PROPERTY</span>
      </a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="ad_lost.php">
        <i class="mdi mdi-account-search menu-icon"></i>
        <span class="menu-title">LOST PROPERTY</span>
      </a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="all_lost_found.php">
        <i class="mdi mdi-account-search menu-icon"></i>
        <span class="menu-title">ALL LOST/FOUND</span>
      </a>
    </li>
  </ul>
</nav>
