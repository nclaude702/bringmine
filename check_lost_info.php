...
if ($stmt) {
    ...
    if ($row = mysqli_fetch_assoc($result)) {
        // Sanitize output data
            $fName = htmlspecialchars($row['lost_names']);
            $fPhone = htmlspecialchars($row['lost_phone']);
            $fDistrict = htmlspecialchars($row['lost_district']);
            $fSector = htmlspecialchars($row['lost_sector']);
            $propertyName = htmlspecialchars($row['lost_property_name']);
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table class="table table-bordered">
                                <tr><th>Lost Name</th> <td><?php echo $fName; ?></td></tr>
                                <tr><th>Lost Phone</th> <td><?php echo $fPhone; ?></td></tr>
                                <tr><th>Lost District</th> <td><?php echo $fDistrict; ?></td></tr>
                                <tr><th>Lost Sector</th> <td><?php echo $fSector; ?></td></tr>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <div class="container">
                                            <h2 class="text-center">Send SMS To Lost Property</h2>
                                            <form id="smsForm" method="POST" action="check_lost_info.php">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        <button type="submit" class="btn btn-primary mt-2">Send SMS To Lost Property</button>
                                                    </div>
                                                </div>
                                            </form>
