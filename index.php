...
<html lang="en">
  <head>
    ...
    <title>Lost and Found Login Page</title>
    <!-- plugins:css -->
    ...
    <!-- endinject -->
    <link rel="shortcut icon" href="assets/images/logooo.jpg" />
  </head>
  <body>
            ...
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                <div class="brand-logo">
                  <center><img src="assets/images/logoo.jpg" alt="logo"></center>
                </div>
             
                <h3 class="font-weight-light"><center>Welcome, Please sign In</center></h3>
